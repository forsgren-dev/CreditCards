...
# example:
# ./database-rebuild-all.sh sql-creditcards sqlserver docker dbo ../AppWebApi
# ./database-rebuild-all.sh sql-creditcards sqlserver docker dbo ../AppRazor
# ./database-rebuild-all.sh sql-creditcards sqlserver docker dbo ../AppMvc
