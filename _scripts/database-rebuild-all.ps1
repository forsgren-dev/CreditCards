...
# example:
# .\database-rebuild-all.ps1 sql-creditcards sqlserver docker dbo ..\AppWebApi
# .\database-rebuild-all.ps1 sql-creditcards sqlserver docker dbo ..\AppRazor
# .\database-rebuild-all.ps1 sql-creditcards sqlserver docker dbo ..\AppMvc
