...
1. Create the database. With Terminal in folder _scripts 
   ...
   macOs
   ./database-rebuild-all.sh sql-creditcards sqlserver docker root ../AppWebApi
   ./database-rebuild-all.sh sql-creditcards mysql docker root ../AppWebApi
   ./database-rebuild-all.sh sql-creditcards postgresql docker root ../AppWebApi
   
   Windows
   .\database-rebuild-all.ps1 sql-creditcards sqlserver docker root ..\AppWebApi
   ./database-rebuild-all.ps1 sql-creditcards mysql docker root ..\AppWebApi
   ./database-rebuild-all.ps1 sql-creditcards postgresql docker root ..\AppWebApi
